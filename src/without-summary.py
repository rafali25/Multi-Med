# Generated from: without-summary.ipynb
# Converted at: 2026-02-26T23:15:15.776Z
...
client = OpenAI(
  ...
  api_key = "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"
  #api_key = "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"
)
...
def driver(facts, options):
    ...
    diagnosis_response = diagnosis(history, options)
...
dataset = pd.read_json("/kaggle/input/datasets/sushant24/icraft-md/all_craft_md.jsonl", lines=True)
...
with open('/kaggle/input/datasets/sushant24/icraft-md/patient facts.pickle', 'rb') as file:
