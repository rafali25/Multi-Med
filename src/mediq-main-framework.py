# Generated from: mediq-main-framework.ipynb
# Converted at: 2026-02-26T23:12:13.276Z
...
def driver(facts, options, dataset_question):
    ...
    while total_questions < 50:
        ...
        while num_questions < 20:
            iresponse = interrogator_agent(history_justified, options, question_type, dataset_question)
            num_questions += 1
            question = ""
            justification = ""
        ...
        expert_response = expert_agent(history_justified, options, dataset_question)
        to_continue = ""
        question_type = ""
    ...
    diagnosis_response = diagnosis(summary, options, dataset_question)
...
dataset = pd.read_json("/kaggle/input/datasets/ekplatebiryani/medqadata/all_dev_good.jsonl", lines=True)
...
with open('/kaggle/input/datasets/ekplatebiryani/medqadata/facts.pickle', 'rb') as file:
...
for i in tqdm(range(len_dataset)):
    ...
    gen_answer = driver(facts_str, options_str, dataset_question)
