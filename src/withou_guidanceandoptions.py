# Generated from: withou_guidanceandoptions.ipynb
# Converted at: 2026-02-26T23:12:43.573Z
...
def interrogator_agent(history, options):
...
def driver(facts, options):
    ...
    while total_questions < 50:
        ...
        while num_questions < 20:
            iresponse = interrogator_agent(history_justified, options)
            num_questions += 1
            question = ""
            justification = ""
